...
Nesses casos, a nossa probabilidade marginal é calculada através de uma integral complexa e nós necessitamos de ferramentes alternativas para chegar à distribuição psoterior do nosso parâmetro de interesse. É aí que entram os algoritmos de Markov Chain Monte Carlo. 

#### 2.3.5.1 Algoritmos MCMC
VAMOS ESCREVER ESSA PARTES JUNTOS...
...
#### 2.3.9.3 Checagem preditiva posterior
